...
const translations = {
  en: {
    ...
    stickers: {
      title: "Stickers",
      subtitle: "Official Chebu Sticker Pack",
      description: "Express your revolutionary spirit with our exclusive sticker pack. 13 unique designs ready for your Telegram chats.",
      getPack: "Get the Sticker Pack",
  ...
  ru: {
    ...
    manifesto: {
      ...
      card1: "Никаких дворян. Только мемы.",
      card2: "Каждый товарищ заслуживает котлету.",
      card3: "Революция уже в Telegram.",
    ...
    propaganda: {
      ...
      card5: "ХОМЯК ПРОДАЁТ — ТОВАРИЩ ПОКУПАЕТ",
      card6: "МЕМЫ — ОРУЖИЕ ПРОЛЕТАРИАТА",
    },
    community: {
      title: "ВСТУПАЙ В ОТДЕЛ ПРОПАГАНДЫ",
      copy: "Каждый мем — это боеприпас. Каждый репост — служение.",
      telegram: "Telegram",
      twitter: "Twitter/X",
      dexScreener: "DexScreener",
      tonviewer: "Tonviewer",
    ...
    stickers: {
      title: "Стикеры",
      subtitle: "Официальный набор стикеров Chebu",
      description: "Выразите свой революционный дух с помощью нашего эксклюзивного набора стикеров. 13 уникальных дизайнов для ваших Telegram чатов.",
      getPack: "Получить набор стикеров",
  ...
  zh: {
    ...
    stickers: {
      title: "贴纸",
      subtitle: "官方 Chebu 贴纸包",
      description: "用我们专属的贴纸包表达你的革命精神。13 个独特设计，随时可用于你的 Telegram 聊天。",
      getPack: "获取贴纸包",
    ...
    supportModal: {
      ...
      body: "使用我们的兑换，在 $TON 上直接购买 CHEBU，把资金注入流动池！",
      cta: "支援这项事业",
      close: "关闭",
    },
    footer: {
